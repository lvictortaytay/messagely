const db = require("../db"); //needs to import the database
const User = require("../models/user"); // will be testing the USER class
const Message = require("../models/message"); // will be testing the MESSAGES class


//this is the seperation of the USER CLASS--------------------------------------------------------------------------------------------------------------------
...
//this is the seperation of the MESSAGES CLASS --------------------------------------------------------------------------------------------------------------------
